    ...
    <SidebarProvider className="theme bg-background">
      ...
      <SidebarInset className="bg-linear-to-b from-background via-background to-secondary/8">
        <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center gap-3 border-b border-border/70 bg-card/94 px-4 backdrop-blur supports-backdrop-filter:bg-card/82 dark:border-border/35">
          <SidebarTrigger className="-ml-1 rounded-lg border border-border/70 bg-card/96 shadow-[0_1px_2px_rgb(15_23_42/6%)] hover:bg-muted/60 dark:border-border/35 dark:bg-card/90 dark:shadow-none" />
          ...
          <Button
            ...
            variant="outline"
            size="icon-sm"
            className="ml-auto rounded-lg border-border/70 bg-card/96 shadow-[0_1px_2px_rgb(15_23_42/6%)] hover:bg-muted/60 dark:border-border/35 dark:bg-card/90 dark:shadow-none"
        ...
        {!selectedTopic ? (
            ...
            <p className="rounded-xl border border-border/70 bg-card/96 p-5 text-sm text-foreground/75 shadow-[0_1px_2px_rgb(15_23_42/5%)] dark:border-border/35 dark:bg-card/90 dark:shadow-none">
              Select a topic to view content.
            </p>
          </div>
        ) : (
            <article className="mx-auto w-full max-w-6xl space-y-4 p-4 md:p-8">
            <div className="rounded-2xl border border-border/70 bg-card/96 p-5 shadow-[0_2px_10px_rgb(15_23_42/5%)] backdrop-blur md:p-7 dark:border-border/35 dark:bg-card/92 dark:shadow-none">
